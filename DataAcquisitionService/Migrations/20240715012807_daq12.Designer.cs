...
namespace DataAcquisitionService.Migrations
{
    ...
    [Migration("20240715012807_daq12")]
    partial class daq12
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAcquisitionService.Models.CorporateAction", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("Book_Closure_End_Date")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("Book_Closure_Start_Date")
                        .HasColumnType("datetime2");

                    b.Property<int?>("CorporateActionRunID")
                        .HasColumnType("int");

                    b.Property<int?>("CorporateActionTypeID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CorporateActionRunID");

                    b.HasIndex("CorporateActionTypeID");
            ...
            modelBuilder.Entity("DataAcquisitionService.Models.CorporateActionRun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CorporateActionRuns");
                });

            modelBuilder.Entity("DataAcquisitionService.Models.CorporateActionType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("CorporateActionTypeRunID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CorporateActionTypeRunID");

                    b.ToTable("CorporateActionTypes");
                });

            modelBuilder.Entity("DataAcquisitionService.Models.CorporateActionTypeRun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CorporateActionTypeRuns");
                });
            ...
            modelBuilder.Entity("DataAcquisitionService.Models.CorporateAction", b =>
                {
                    b.HasOne("DataAcquisitionService.Models.CorporateActionRun", "CorporateActionRun")
                        .WithMany()
                        .HasForeignKey("CorporateActionRunID");

                    b.HasOne("DataAcquisitionService.Models.CorporateActionType", "CorporateActionType")
                        .WithMany()
                        .HasForeignKey("CorporateActionTypeID");

                    b.HasOne("DataAcquisitionService.Models.Security", "Security")
                        .WithMany()
                        .HasForeignKey("SecurityID");

                    b.Navigation("CorporateActionRun");

                    b.Navigation("CorporateActionType");
            ...
            modelBuilder.Entity("DataAcquisitionService.Models.CorporateActionType", b =>
                {
                    b.HasOne("DataAcquisitionService.Models.CorporateActionTypeRun", "CorporateActionTypeRun")
                        .WithMany()
                        .HasForeignKey("CorporateActionTypeRunID");

                    b.Navigation("CorporateActionTypeRun");
                });
